...
RELEASE_TYPE="HEAD"  # Set to "HEAD" to allow specific version
SPECIFIED_VERSION="2024.9.23-HEAD+1000"  # Set this to the desired version, e.g., "v1.0.0"
...
# If files were found, check for the specified version
latest_file="$SPECIFIED_VERSION"
